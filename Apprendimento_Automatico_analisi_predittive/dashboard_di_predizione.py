# -*- coding: utf-8 -*-
"""Tesi_Gamberini: Dashboard_di_Predizione.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1o16naCS0C706khjFKP6L75mbwCVxMVrg
...
Prima di utilizzare la dashboard per la predizione, assicurarsi di aver eseguito il Capitolo 0 per l'importazione delle librerie e il Sottoprargrafo 1.1.1. per GB.c. e 1.2.1. per ANN.r. per la preparazione necessaria della dashboard.
...
"""# **2. Preparazione dataset per eventuale verifica** (non avviare)
